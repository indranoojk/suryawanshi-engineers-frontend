...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col-reverse lg:flex lg:flex-row justify-center items-center lg:justify-between lg:items-baseline bg-black px-8">
        <div className="justify-start">
          <p className={`text-lg pb-4 text-white`}>
            @2025 Surywanshi Engineers
          </p>
        </div>

        <div className='m-2 flex space-x-4 justify-end col-span-2 mr-8 -mt-6 lg:-mt-10 lg:col-start-4'>
