...
// // Add Project Code without add image feature
// import React, { useState } from 'react';
// import PlainNav from './PlainNav';
// import Sidebar from './Sidebar/Sidebar';
// import { baseUrl } from "../Urls";
...
//               <input type="text" className="input-class mt-0 block w-full lg:w-80 px-0.5 bg-transparent border-0 border-b-2 border-[#716c6a] focus:ring-0 focus:border-gray-400" id="image" name="image" value={projectDetails.imageUrl} onChange={changeHandler} required />
//             </div>
//             <div>
