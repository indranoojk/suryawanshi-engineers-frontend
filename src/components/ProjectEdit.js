                ...
                {allprojects.map((e, index) => (
                  <tr key={index} className='text-center'>
                    <td className='lg:px-8 border border-black p-1 lg:p-2'>
                      <img className='w-28 lg:w-48 object-contain rounded-md' src={e.image} alt="" />
                    </td>
                    ...
                    <td className='lg:px-8 border border-black p-1 w-28 lg:p-2 lg:w-96'><pre className='text-wrap text-start hidden lg:block'>{e.content}</pre></td>
